...
<html>
  <head>
    ...
    <style>
      ...
      .loader {
        ...
        border-top: 8px solid rgb(144, 100, 18);
        border-radius: 50%;
        width: 60px;
        height: 60px;
  ...
  <body>
    ...
    // Remove loader element on message
    function removeLastMessage() {
      ...
      async function sendMessage() {
        ...
        // Remove the loader message and then append the actual bot response when obtained from Gemini
        removeLastMessage();
